            ...
            <div className="container relative px-4 sm:px-4 w-full max-w-[100vw] box-border">
                ...
                <div className="grid grid-cols-12 gap-0 sm:gap-8 md:gap-12 pt-8 sm:pt-12 md:pt-[70px] ">
                    ...
                    <div className="col-span-12 md:col-span-6 min-w-0 my-auto order-2">
                        ...
                        Discover our 100+ real-world case studies that display our work ethic and the quality of our intuitive e-commerce sites. Our process goes beyond curating basic e-commerce systems. See how our stores offer consistent sales and high-yield results.<br />
                        Explore our future-friendly e-commerce systems that offer optimal results and user-friendly interfaces, while having the ability to scale further with your brand.
                        </div>
