...
const STEPS = [
  {
    ...
    desc: "Our expert gathers all relevant information and documentation to understand your environment, operations, and the system's requirements. The output of this stage is a defined scope, a chosen IoT tech stack, and a shared understanding of what a successful deployment looks like at both technical and commercial levels.",
  },
  {
    title: "Architecture",
    desc: "We map out the complete IoT system architecture, device layer, connectivity method, data processing approach, and cloud setup. Where appropriate, we build a working prototype to validate assumptions early and reduce risk downstream.",
  },
  {
    title: "Development",
    desc: "Our engineers build across the full IoT stack in structured sprints, firmware, backend, cloud data pipelines, and user interface, all developed in parallel by a coordinated team. Platform-specific behavior, edge cases in signal processing, and data accuracy are all accounted for as development progresses.",
  },
  {
    title: "Validations and Testing",
    desc: "IoT systems are tested on real hardware in conditions that mirror your actual environment. We validate connectivity stability, data integrity, processing accuracy, and interface responsiveness. Each sprint is stable before it moves forward, with no deferred fixes.",
  },
  {
    title: "Deployment and Support",
    desc: "We handle device provisioning, cloud configuration, and go-live coordination. Once your IoT solution is live, we stay close to tracking system health, resolving edge cases, and supporting the growth of your connected device ecosystem over time.",
  },
];
  ...
  return (
    ...
    >
      <Image
        ...
        alt="Decorative purple gradient behind IoT development process section"
        width={1000}
        height={1000}
      />
      <div className="grid grid-cols-12 gap-6 sm:gap-5 relative z-10">
        <div className="col-span-12 md:col-span-5 min-w-0 order-1">
          <div className="pb-6 sm:pb-[40px] max-sm:flex max-sm:justify-center">
            <CapsuleLabel firstWord="OUR" secondWord="IOT" thirdWord="PROCESS" />
          </div>
          <div className="font-britanicaBlack text-[24px] leading-tight sm:text-[32px] md:text-[42px] md:leading-[45px] font-black break-words max-sm:text-center">
            <span className="text-white">How do we </span>
            <span className="text-[#F74B1C]">deliver IoT Projects</span>
          </div>
