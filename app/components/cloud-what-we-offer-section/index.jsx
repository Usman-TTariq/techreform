...
const CARDS = [
  {
    ...
    desc: "Not sure which cloud development approach fits your product? Our consulting service helps you make that decision quickly. We assess your requirements, user base, and long-term goals to recommend the right cloud architecture before any work begins.",
  },
  {
  ...
  },
  {
    ...
    desc: "We set up and manage the cloud infrastructure for your product. We handle the technical foundation so your team can focus on building. This includes everything from CI/CD pipelines to environment configuration and monitoring.",
  },
  {
        ...
        <div className="grid grid-cols-12">
          <div className="col-span-12 text-center min-w-0">
            ...
            <div className="font-britanicaBlack text-[24px] leading-tight sm:text-[32px] md:text-[42px] md:leading-[52px] font-black break-words">
              ...
              <span className="text-[#F74B1C]">Cloud Development Services</span>
            </div>
          </div>
        </div>
...
export default CloudWhatWeOfferSection;
