...
const DatingCaseStudiesSection = () => {
        ...
        <div className="grid grid-cols-12 justify-between gap-4">
          <div className="col-span-12 lg:col-span-10">
            <div className="font-britanicaBlack text-[28px] leading-tight sm:text-[36px] md:text-[44px] lg:text-[50px] lg:leading-[42px] font-black pb-4 sm:pb-[26px] text-left max-sm:text-center">
              <span className="text-[#F74B1C]">Apps That Helped People </span>
              <span className="text-white">Find Their Match</span>
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-6">
            <div className="h-full flex items-center justify-center">
              <Image
                ...
                alt="iPhone mockup showing dating app case study screens"
                width={1000}
                height={1000}
              />
            </div>
          ...
          <div className="col-span-12 md:col-span-6">
            <div>
              <Image
                ...
                alt="Multiple smartphone mockups for dating app case studies"
                width={1000}
                height={1000}
              />
            </div>
            <div className="font-britanicaRegular text-base sm:text-[18px] md:text-[20px] text-white pt-4 sm:pt-[22px] max-sm:text-center leading-relaxed">
              Explore our 100+ real-world case studies to see how our dating app development services have helped
              startups and brands launch successful platforms. From AI-powered matchmaking apps to niche dating
              communities, our developers have helped clients boost user engagement, speed up time to market, and scale
              with confidence.
            </div>
...
export default DatingCaseStudiesSection;
