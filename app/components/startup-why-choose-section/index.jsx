...
const WHY_CHOOSE = [
  {
    title: "Unclear Idea",
    desc: "We refine your concept into a clear product roadmap.",
  },
  {
    title: "Tech Confusion",
    desc: "We guide founders through the right development stack.",
  },
  {
    title: "Too Much to Manage",
    desc: "Our startup app development agency handles design, development, and deployment.",
  },
  {
    title: "Budget Concerns",
    desc: "We provide affordable app development for startups without sacrificing quality.",
  },
];

const StartupWhyChooseSection = () => {
  ...
  return (
    ...
    >
      <Image
        ...
        alt="Decorative purple gradient behind why choose us for startup development section"
        width={1000}
        height={1000}
      />
      <div className="grid grid-cols-12 gap-6 sm:gap-5 pt-8 sm:pt-12 md:pt-[70px] relative z-10">
        <div className="col-span-12 md:col-span-5 min-w-0 order-1 md:order-2">
          <div className="font-britanicaBlack text-[28px] leading-tight sm:text-[38px] md:text-[50px] md:leading-[55px] font-black break-words max-sm:text-center">
            <span className="text-[#F74B1C]">Simple Solutions </span>
            <br />
            <span className="text-white">for Startup Challenges</span>
          </div>
          {/* <div className="font-britanicaRegular text-[15px] sm:text-[18px] md:text-[20px] font-regular text-white pt-4 sm:pt-[22px] leading-relaxed max-w-full max-sm:text-center">
            We help startups ship products that work in the real world—fast enough to learn, solid enough to grow, with a partner who stays after launch day.
          </div> */}
        </div>
...
export default StartupWhyChooseSection;
