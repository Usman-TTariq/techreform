...
const CrossPlatformCaseStudiesSection = () => {
        ...
        <div className="grid grid-cols-12 justify-between gap-4">
          <div className="col-span-12 lg:col-span-10">
            <div className="font-britanicaBlack text-[28px] leading-tight sm:text-[36px] md:text-[44px] lg:text-[50px] lg:leading-[42px] font-black pb-4 sm:pb-[26px] text-left max-sm:text-center">
              ...
              <span className="text-white">Cross-Platform Apps Perform in the </span>
        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-12 pt-10 sm:pt-16 md:pt-[70px]">
          <div className="col-span-12 md:col-span-6">
            <div className="h-full flex items-center justify-center">
              <Image
                ...
                alt="iPhone mockup showing cross-platform app case study screens"
                width={1000}
                height={1000}
              />
            </div>
          ...
          <div className="col-span-12 md:col-span-6">
            <Image
              ...
              alt="Multiple smartphone mockups for cross-platform app case studies"
              width={1000}
              height={1000}
            />
...
export default CrossPlatformCaseStudiesSection;
