...
import { TOP_APP_FAQ_ITEMS } from "@/app/constants/top-app-developers-content";

const TopAppFaqSection = () => {
  const [openId, setOpenId] = useState(TOP_APP_FAQ_ITEMS[0]?.id ?? null);
...
export default TopAppFaqSection;
