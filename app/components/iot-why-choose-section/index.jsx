...
const WHY_CHOOSE = [
  {
    ...
    desc: "From the sensor on the factory floor to the dashboard on the executive's screen, we own the entire delivery. One team, one point of accountability, and no gaps between hardware and software teams pointing fingers at each other.",
  },
  {
    title: "No Overclaiming",
    desc: "IoT technology has genuine limitations depending on the environment, connectivity, and data volume. We scope honestly, flag risks early, and give you a clear-eyed view of what the system can and cannot do, so you make informed decisions at every stage.",
  },
  {
    title: "Built for Real Environments",
    desc: "Office demos are easy. Industrial IoT deployments in warehouses, construction sites, and healthcare facilities are not. We build and test for the conditions your system will actually face: variable connectivity, dust, temperature, and high-frequency data loads.",
  },
  {
    title: "Long-Term Partnership",
    desc: "A connected system is never truly finished. New devices get added, data needs evolve, and scale changes everything. We build with that reality in mind and remain an active technical partner long after your initial IoT deployment goes live.",
  },
];

const IotWhyChooseSection = () => {
  ...
  return (
    ...
    >
      <Image
        ...
        alt="Decorative purple gradient behind why choose us for IoT development section"
        width={1000}
        height={1000}
      />
      <div className="grid grid-cols-12 gap-6 sm:gap-5 pt-8 sm:pt-12 md:pt-[70px] relative z-10">
        <div className="col-span-12 md:col-span-5 min-w-0 order-1 md:order-2">
          ...
          <div className="font-britanicaRegular text-[15px] sm:text-[18px] md:text-[20px] font-regular text-white pt-4 sm:pt-[22px] leading-relaxed max-w-full max-sm:text-center">
            We combine embedded engineering with cloud and product discipline—so your connected devices stay reliable, observable, and maintainable as your fleet grows.
          </div>
        </div>
...
export default IotWhyChooseSection;
