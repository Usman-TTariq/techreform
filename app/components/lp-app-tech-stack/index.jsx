...
const LpAppTechStack = () => {
    return (
        <div className="relative mb-[140px] max-sm:mb-[40px]">
            <div className="container">
                <div className="bg-black overflow-hidden rounded-[50px]">
                    <div className="grid grid-cols-12 px-[40px] py-[60px] max-sm:px-[10px] max-sm:py-[20px]">
                        <div className="col-span-9 max-lg:col-span-12">
                            <div className="flex justify-start max-sm:justify-center">
                                <div className="font-britanicaBlack text-[28px] leading-tight sm:text-[36px] md:text-[44px] lg:text-[55px] lg:leading-[42px] font-black pb-4 sm:pb-[26px] text-left max-sm:text-center">
