...
const CARDS = [
  {
    ...
    desc: "We build custom iPhone and iPad apps tailored to your business model, user goals, and long-term roadmap. Every feature is planned for performance, scalability, and a polished native experience.",
  },
  {
    title: "UI/UX for iOS Products",
    desc: "Our designers craft clean, intuitive iOS interfaces aligned with Apple design standards. We focus on smooth navigation, accessibility, and high-conversion user flows.",
  },
  {
    title: "API and Backend Integration",
    desc: "From authentication and payments to analytics and third-party tools, we integrate secure backend services that keep your iOS app stable, fast, and data-driven.",
  },
  {
    title: "Testing, Launch, and Support",
    desc: "We handle QA across iOS devices, App Store submission, and post-launch improvements. Your app stays reliable with ongoing updates, fixes, and optimization.",
  },
];
        ...
        <div className="grid grid-cols-12">
          <div className="col-span-12 text-center min-w-0">
            ...
            <div className="font-britanicaBlack text-[24px] leading-tight sm:text-[32px] md:text-[42px] md:leading-[52px] font-black break-words">
              <span className="text-white">End-to-End iOS </span>
