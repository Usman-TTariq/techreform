        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-12 pt-10 sm:pt-16 md:pt-[70px]">
          ...
          <div className="col-span-12 md:col-span-6">
            ...
            <div className="font-britanicaRegular text-base sm:text-[18px] md:text-[20px] font-regular text-white pt-4 sm:pt-[22px] max-sm:text-center">
              We have delivered IoT solutions across manufacturing, healthcare, real estate, logistics, and retail. Each project presented different constraints and required a different approach. Our portfolio reflects that range.
            </div>
