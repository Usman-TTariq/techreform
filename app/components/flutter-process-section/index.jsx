...
const STEPS = [
  { title: "Product Discovery & Planning", desc: "We define your app scope, user journeys, and feature priorities to build a clear Flutter roadmap for fast and efficient execution." },
  { title: "UI/UX & App Architecture", desc: "Our team designs reusable UI systems and scalable architecture so your Flutter app stays maintainable and delivers consistent performance across platforms." },
  { title: "Development & QA Testing", desc: "We build in agile sprints and run complete QA on Android and iOS devices to ensure smooth UI behavior, stable APIs, and reliable app performance." },
  { title: "Release & Post-Launch Support", desc: "We help with deployment, store readiness, and continuous updates so your Flutter app remains optimized, secure, and ready to scale." },
];
    ...
    <div ref={sectionRef} className="container relative pb-12 sm:pb-16 md:pb-[120px] px-4 sm:px-4 w-full max-w-[100vw] box-border overflow-hidden">
      ...
      <div className="grid grid-cols-12 gap-6 sm:gap-5 relative z-10">
        <div className="col-span-12 md:col-span-5 min-w-0 order-1">
          <div className="pb-6 sm:pb-[40px]"><CapsuleLabel firstWord="OUR" secondWord="FLUTTER APP" thirdWord="PROCESS" /></div>
          <div className="font-britanicaBlack text-[24px] leading-tight sm:text-[32px] md:text-[42px] md:leading-[45px] font-black break-words">
            <span className="text-white">Our Process for Scalable</span><br /><span className="text-[#F74B1C]">Flutter App Development</span>
          </div>
          <div className="pt-5 sm:pt-[30px]"><Button text="Learn More" icon={false} onClick={() => setPopupOpen(true)} /></div>
        </div>
