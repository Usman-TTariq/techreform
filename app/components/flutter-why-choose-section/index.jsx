...
const WHY_CHOOSE = [
  { title: "Cross-Platform Expertise", desc: "We build robust Flutter apps that run smoothly across Android and iOS with a consistent codebase and predictable release cycles." },
  { title: "Fast, Business-Driven Delivery", desc: "Our approach focuses on shipping useful features quickly while keeping quality high, so your product can go to market faster." },
  { title: "Quality and Performance Focus", desc: "From architecture to QA, we optimize app responsiveness, stability, and scalability so your Flutter app performs well in real-world usage." },
  { title: "Long-Term Product Partnership", desc: "Beyond launch, we support app evolution with feature updates, bug fixes, and performance improvements aligned with your growth roadmap." },
];
    ...
    <div ref={sectionRef} className="container relative pb-12 sm:pb-16 md:pb-[120px] px-4 sm:px-4 w-full max-w-[100vw] box-border overflow-hidden">
      ...
      <div className="grid grid-cols-12 gap-6 sm:gap-5 pt-8 sm:pt-12 md:pt-[70px] relative z-10">
        <div className="col-span-12 md:col-span-5 min-w-0 order-1 md:order-2">
          <div className="font-britanicaBlack text-[28px] leading-tight sm:text-[38px] md:text-[50px] md:leading-[55px] font-black break-words"><span className="text-[#F74B1C]">Why Choose </span><br /><span className="text-white">Us?</span></div>
          <div className="font-britanicaRegular text-[15px] sm:text-[18px] md:text-[20px] font-regular text-white pt-4 sm:pt-[22px] leading-relaxed max-w-full">
            We combine cross-platform engineering with product-focused execution to deliver Flutter apps that are reliable, scalable, and ready for long-term business growth.
          </div>
        </div>
