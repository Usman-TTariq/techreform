...
const STATS = [
  { value: "200+", label: "Flutter projects delivered" },
...
const WHY_CHOOSE = [
  {
    title: "Flutter-Only Specialists",
    desc: "Our developers work exclusively in Flutter and Dart — no generalist coders moonlighting as mobile devs. Every engineer has delivered cross-platform iOS and Android apps from a single codebase in production environments.",
    tags: ["Flutter SDK", "Dart", "Cross-platform"],
    buttonText: "View Developer Profiles",
  },
  {
    title: "NDA-Protected Engagement",
    desc: "Every Flutter developer engagement is covered by a signed NDA before work begins. Your app architecture, source code, and product roadmap stay confidential — no exceptions, no negotiation required.",
    tags: ["IP Protection", "Signed NDA", "Confidentiality"],
    buttonText: "See Our Security Standards",
  },
  {
    title: "Flexible Engagement Models",
    desc: "Scale your Flutter team up or down based on your sprint cycle — no long-term contracts, no hidden fees. Hire one developer for a focused feature build or a full Flutter team for an enterprise app rollout.",
    tags: ["Full-time", "Part-time", "Project-based"],
    buttonText: "Explore Hiring Models",
  },
  {
    title: "Cost-Efficient Without Compromise",
    desc: "Hiring a Flutter developer through Tech Reforms costs significantly less than a local full-time hire — without sacrificing code quality, communication standards, or delivery accountability.",
    tags: ["No recruitment overhead", "Transparent pricing"],
    buttonText: "Compare Engagement Costs",
  },
];

const HireFlutterWhyChooseSection = () => {
  ...
  return (
    ...
    >
      <Image
        ...
        alt="Decorative purple gradient behind why choose Tech Reforms for hiring Flutter developers section"
        width={1000}
        height={1000}
      />
      <div className="grid grid-cols-12 gap-6 sm:gap-5 pt-8 sm:pt-12 md:pt-[70px] relative z-10">
        <div className="col-span-12 md:col-span-5 min-w-0 order-1 md:order-2">
          <div className="font-britanicaBlack text-[24px] leading-tight sm:text-[32px] md:text-[40px] md:leading-[48px] font-black break-words max-sm:text-center">
            <span className="text-white">Why Leading Businesses Choose Tech Reforms as Their </span>
            <span className="text-[#F74B1C]">Flutter Development Partner</span>
          </div>
          <div className="font-britanicaRegular text-[14px] sm:text-[16px] md:text-[17px] font-regular text-white pt-4 sm:pt-5 leading-relaxed max-w-full max-sm:text-center space-y-4">
            <p>
              Hundreds of Flutter developers are available online. What separates a good Flutter agency from a costly hiring mistake is accountability, technical depth, and zero-friction integration into your existing workflow.
            </p>
            <p>
              At Tech Reforms, every Flutter developer we place is pre-vetted on real app delivery — not just Dart syntax. You get engineers who ship, communicate, and own their sprint commitments.
            </p>
          </div>
          ...
          <div className="pt-6 sm:pt-8 max-sm:flex max-sm:justify-center">
            <Button text="Work With Our Flutter Team" icon={false} onClick={() => setPopupOpen(true)} />
          </div>
        </div>
...
export default HireFlutterWhyChooseSection;
