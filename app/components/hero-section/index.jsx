...
import heroLaptop from "../../../public/images/herolaptop.png";
import { ikUrl } from "@/app/utils/imagekit";
import HeroScheduleButton from "./hero-schedule-button";
  ...
  return (
    <div className="relative w-full min-w-0 min-h-[85vh] sm:min-h-[80vh] md:min-h-[90vh] lg:min-h-[110vh] pb-16 sm:pb-12 md:pb-0 overflow-hidden bg-[#0E0E0E]">
      <Image
        ...
        width={heroLaptop.width}
        height={heroLaptop.height}
        quality={55}
      ...
      <Image
        ...
        src={ikUrl("Group%202147225267.png", 480)}
      ...
      <Image
        ...
        src={ikUrl("frame2_h4xmpf.webp", 480)}
      ...
      <div className="container relative z-10 px-4 sm:px-4 w-full max-w-[100vw]">
        <div className="absolute top-[99%] left-4 right-auto sm:top-[12%] sm:left-auto sm:right-8 md:right-12 lg:right-[200px] module-border-wrap w-[130px] sm:w-auto z-0">
          <div className="bg-neutral-950 rounded-2xl md:rounded-4xl px-3 py-2.5 sm:px-4 md:px-[30px] md:py-[10px] glass-card">
            <div className="text-[22px] sm:text-[32px] md:text-[36px] font-semibold tracking-tight text-white font-britanicaExtraBold">
              98%
            </div>
        ...
        <div className="absolute top-[72%] sm:top-[50%] translate-y-[90%] right-4 sm:right-8 lg:right-0 hidden sm:block">
          <div className="text-[14px] sm:text-[22px] md:text-[26px] lg:text-[30px] font-britanicaBlack text-white capitalize leading-tight">
            we reinvent
          </div>
          <div className="text-[14px] sm:text-[22px] md:text-[26px] lg:text-[30px] font-britanicaBlack text-white capitalize leading-tight">
            business via
        ...
        <div className="grid grid-cols-12 pt-12 sm:pt-[90px] md:pt-[100px] lg:pt-[120px] relative z-20">
          <div className="col-span-12 lg:col-span-6">
            <h1 className="font-britanicaBlack text-[26px] leading-[1.2] sm:text-[36px] md:text-[46px] lg:text-[50px] lg:leading-[52px] font-black">
              <span className="text-white">Digitize Your Business</span>
              <br />
              <span className="text-[#F74B1C]">Through Innovation</span>
            </h1>
