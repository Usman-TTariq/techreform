            ...
            <div className="container relative px-4 sm:px-4 w-full max-w-[100vw] box-border">
                ...
                <div className="grid grid-cols-12 gap-6 sm:gap-8 md:gap-12 pt-8 sm:pt-12 md:pt-[70px]">
                    ...
                    <div className="col-span-12 md:col-span-6 min-w-0 my-auto order-2">
                        ...
                        Explore over 100 examples of how our custom AR development solutions guide real-world work. Powered by 50+ certified developers, we have helped teams speed training, improve field accuracy, and launch high-impact retail activations.
                        </div>
                        <div className="font-britanicaRegular text-[15px] sm:text-[18px] md:text-[20px] font-regular text-white pt-4 sm:pt-[22px] leading-relaxed max-w-full">
                        Discover AR experiences built for clarity and speed. Our solutions offer stable tracking, crisp on-device rendering, and content workflows that make updates painless as your roadmap evolves.
                        </div>
...
export default ArCaseStudySection;
