...
const ProcessSection = ({
  capsule = { firstWord: "OUR", secondWord: "DEVELOPMENT", thirdWord: "PROCESS" },
  heading = {
    line1: "Optimized Process for",
    line2: "High-Performance Enterprise Solutions",
  },
  steps = [],
  backgroundImage = "/images/whatwedobk.png",
  backgroundAlt = "Decorative gradient behind development process section",
      ...
      <div className="grid grid-cols-12 gap-6 sm:gap-5 relative z-10">
        <div className="col-span-12 md:col-span-5 min-w-0 order-1">
          ...
          <div className="font-britanicaBlack text-[24px] leading-tight sm:text-[32px] md:text-[42px] md:leading-[45px] font-black break-words">
            {heading.line1 ? (
              <>
                <span className="text-white">{heading.line1}</span>
                <br />
              </>
            ) : null}
            {heading.line2 ? (
              <span className="text-[#F74B1C]">{heading.line2}</span>
            ) : null}
          </div>
