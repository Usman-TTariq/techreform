...
const CARDS = [
  {
    ...
    desc: "Every restaurant runs differently, so your app should too. We build custom restaurant apps shaped around your menu, your branding, and how your customers actually order food.",
  },
  {
    title: "Restaurant Reservation App Development",
    desc: "Let guests book a table in seconds with live availability and automated reminders, cutting down no-shows and making sure your tables never sit empty during peak hours.",
  },
  {
    title: "Restaurant Loyalty App Development",
    desc: "Turn first-time orders into repeat business with built-in rewards, points, and personalized offers that keep customers coming back to your app instead of a competitor's.",
  },
  {
    title: "AI-Powered Restaurant App Development",
    desc: "Stay ahead with smart features like AI-based menu suggestions and automated order support, giving your restaurant an edge that basic ordering apps simply can't match.",
  },
];

const RestaurantWhatWeOfferSection = () => {
        ...
        <div className="grid grid-cols-12">
          <div className="col-span-12 text-center min-w-0">
            ...
            <div className="font-britanicaBlack text-[24px] leading-tight sm:text-[32px] md:text-[42px] md:leading-[52px] font-black break-words">
              <span className="text-white">Smart Restaurant Apps for </span>
              <span className="text-[#F74B1C]">Smarter Food Businesses</span>
            </div>
          </div>
        </div>
...
export default RestaurantWhatWeOfferSection;
