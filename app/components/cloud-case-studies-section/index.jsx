      ...
      <div className="container relative px-4 sm:px-4">
        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-12 pt-10 sm:pt-16 md:pt-[70px]">
          ...
          <div className="col-span-12 md:col-span-6">
            ...
            We have delivered cloud development projects across a broad range of industries and use cases. Browse our portfolio to see how we approach different types of products and the results we have produced for our clients.
            </div>
