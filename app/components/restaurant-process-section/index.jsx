...
const STEPS = [
  {
    ...
    desc: "We start by understanding your restaurant's menu, order flow, and the features you actually need, whether that's online ordering, delivery tracking, or table reservations, before any code gets written.",
  },
  {
    title: "UI/UX Design",
    desc: "Next, we design a clean, easy-to-navigate app so customers can browse your menu and order without confusion, while your staff gets a dashboard that's just as simple to manage.",
  },
  {
    title: "Development & Integration",
    desc: "Our developers build your restaurant app with secure payment gateways, real-time order tracking, and POS integration, so everything from checkout to kitchen runs smoothly from day one.",
  },
  {
    title: "Testing, Launch & Support",
    desc: "Before going live, we test your app across devices and order scenarios, then continue supporting it after launch with updates and fixes as your restaurant business grows.",
  },
];

const RestaurantProcessSection = () => {
  ...
  return (
    ...
    >
      <Image
        ...
        alt="Decorative purple gradient behind restaurant app development process section"
        width={1000}
        height={1000}
      />
      <div className="grid grid-cols-12 gap-6 sm:gap-5 relative z-10">
        <div className="col-span-12 md:col-span-5 min-w-0 order-1">
          <div className="pb-6 sm:pb-[40px] max-sm:flex max-sm:justify-center">
            <CapsuleLabel firstWord="OUR" secondWord="RESTAURANT APP" thirdWord="PROCESS" />
          </div>
          <div className="font-britanicaBlack text-[24px] leading-tight sm:text-[32px] md:text-[42px] md:leading-[45px] font-black break-words max-sm:text-center">
            <span className="text-white">A Smarter Way to </span>
            <br />
            <span className="text-[#F74B1C]">Build Your Restaurant App</span>
          </div>
...
export default RestaurantProcessSection;
