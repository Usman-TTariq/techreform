    ...
    return (
        <div ref={sectionRef} className="container relative pb-12 sm:pb-16 md:pb-[120px] px-4 sm:px-4 w-full max-w-[100vw] box-border overflow-hidden">
            <Image
                ...
                alt="Decorative purple gradient behind staff augmentation services section"
                width={1000}
                height={1000}
            />
                        ...
                        >
                            {solutions.map((solution, index) => (
                                <SwiperSlide key={index} className="!h-auto">
                                    <div className="bg-white h-[420px] sm:h-[460px] md:h-[500px] border-2 border-[#7724C1] rounded-2xl p-4 sm:p-6 md:p-[30px] flex flex-col">
                                        ...
                                        <div className="font-britanicaRegular text-[#373636] text-[13px] sm:text-[16px] leading-relaxed flex-1 min-h-0 pb-4 sm:pb-[30px]">
                                            {solution.desc}
                                        </div>
